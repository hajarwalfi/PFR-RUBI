                    ...
                    @if($articles->isNotEmpty())
                        ...
                        <div class="mb-6 relative">
                            @if($articles->first()->picture)
                                ...
                                >
                            @else
                                <div class="w-full h-[460px] bg-gray-100"></div>
                            @endif
                        </div>

                        <!-- Featured Tag -->
                        <div class="uppercase text-gray-500 text-xs tracking-widest mb-3 font-medium">Article à la une</div>

                        <!-- Featured Title -->
                        <h1 class="font-serif text-2xl mb-4 leading-tight">
                            {{ $articles->first()->title }}
                        </h1>

                        <!-- Featured Excerpt -->
                        <p class="text-gray-600 mb-4 text-sm leading-relaxed">
                            {{ Str::limit(strip_tags($articles->first()->content), 180) }}
                        </p>
                ...
                <div class="lg:col-span-7">
                    ...
                    <div class="mt-12 text-center">
                        <a href="#" class="inline-flex items-center text-gray-500 hover:text-gray-900">
                            <span class="mr-2">Plus d'articles</span>
