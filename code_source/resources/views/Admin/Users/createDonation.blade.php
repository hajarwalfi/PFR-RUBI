...
@section('content')
    ...
    <main class="flex-1 p-6">
        ...
        <div class="flex items-center space-x-2 text-xs">
            <a href="{{ route('Users.show', $user->id ?? 0) }}" class="inline-flex items-center p-2 rounded-md hover:bg-gray-100">
                <i class="fas fa-arrow-left h-2 w-4"></i>
            </a>
            <div class="flex items-center text-gray-500">
                <a href="{{ route('Users.index') }}" class="hover:text-black hover:underline">Donors</a>
                <span class="mx-2">&gt;</span>
                <a href="{{ route('Users.show', $user->id ?? 0) }}" class="hover:text-black hover:underline">{{ $user->first_name ?? '' }} {{ $user->last_name ?? '' }}</a>
                <span class="mx-2">&gt;</span>
        ...
        <form action="{{ route('Donations.store') }}" method="POST">
            ...
            <div class="bg-white rounded-md border border-gray-200 p-6">
                ...
                <div class="flex justify-between mt-6">
                    <a href="{{ route('Users.show', $user->id ?? 0) }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium">Cancel</a>
