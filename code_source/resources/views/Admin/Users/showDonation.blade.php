    ...
    <main class="flex-1">
        ...
        <div class="p-4 flex justify-between items-center border-b border-gray-200">
            <div class="flex items-center space-x-2">
                ...
                <span class="text-gray-500">Donneurs > {{ $donation->user->first_name }} {{ $donation->user->last_name }} > Détails du don</span>
            </div>
        ...
        <section class="p-6">
            ...
            <section class="mb-6">
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-gray-600">{{ $donation->date->format('d/m/Y') }}</span>
                </div>
            </section>
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div class="p-4 border-b border-gray-200 flex">
                            <div class="w-1/2 flex items-start">
                                <i class="far fa-calendar-alt h-4 w-4 text-gray-400 mr-2 mt-0.5"></i>
                                <div>
                            ...
                            <div class="w-1/2 flex items-start">
                                <i class="fas fa-tint h-4 w-4 text-gray-400 mr-2 mt-0.5"></i>
                                <div>
                        ...
                        <div class="p-4 flex">
                            <div class="w-1/2 flex items-start">
                                <i class="fas fa-map-marker-alt h-4 w-4 text-gray-400 mr-2 mt-0.5"></i>
                                <div>
                            ...
                            <div class="w-1/2 flex items-start">
                                <i class="fas fa-user h-4 w-4 text-gray-400 mr-2 mt-0.5"></i>
                                <div>
                ...
                <div class="col-span-5 border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        @if($donation->observations && $donation->observations->count() > 0)
                            @foreach($donation->observations as $observation)
