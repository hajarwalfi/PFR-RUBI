...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 px-8 mb-8">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-3 px-4">
            ...
            <div class="text-2xl font-semibold mb-1">60 %</div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-3 px-4">
            ...
            <div class="text-gray-500 text-xs ">En attente de validation </div>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 mx-8 mb-8">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-xs">
                ...
                <tr class="border-b border-gray-200">
                    ...
                    <td class="px-6 text-center py-4">O-</td>
                    <td class="px-6 py-4">
                ...
                <tr class="border-b border-gray-200">
                    ...
                    <td class="px-6 py-4">sara.benali@example.com</td>
                    <td class="px-6 py-4">
                        <span class="px-3 py-1 bg-red-50 text-red-700 rounded-full text-xs">Inéligible</span>
                    </td>
        ...
        <div class="p-4 flex justify-end items-center border-t border-gray-200">
            <div class="flex items-center gap-2">
                <button class="p-2 rounded-md border text-xs border-gray-300 text-gray-500">
