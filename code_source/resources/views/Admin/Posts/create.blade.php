...
@section('title', 'RUBI Admin - Nouvelle Publication')
...
@section('content')
    <div class="p-8">
        <div class="flex items-center mb-6">
            ...
            <div>
                <h1 class="text-3xl font-bold">Nouvelle Publication</h1>
                <p class="text-l font-regular text-gray-500">Créer une nouvelle publication officielle</p>
            </div>
        </div>
    </div>
    ...
    <div class="px-8 mb-8">
        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                ...
                <p class="text-gray-500 text-sm">Remplissez les informations pour créer une nouvelle publication</p>
            </div>
                ...
                <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="title" id="title" class="shadow-sm focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('title') }}" required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="content" name="content" rows="8" class="shadow-sm focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md" required>{{ old('content') }}</textarea>
                            </div>
                        </div>
